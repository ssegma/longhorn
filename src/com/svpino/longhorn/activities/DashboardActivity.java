...
public class DashboardActivity extends FragmentActivity implements StockListFragmentCallback, StockQuoteCollectorObserver {
	...
	private StockListFragment stockListFragment;
		...
		public static final String ACTION_NOTIFY = "com.svpino.longhorn.activities.NOTIFY";
	...
	/**
	 * Send a notification using the NotificationCompat.Builder API.
	 */
	public void sendNotification(View view) {
		...
		Stock localStock = StockListFragment.focusStock;
		builder.setContentTitle(localStock.getSymbol());
		builder.setContentText(localStock.getPrice().toString());
		 ...
		 * notification bar.
		 */
		NotificationManagerCompat notificationManagerWear =
						NotificationManagerCompat.from(this);
		notificationManagerWear.notify(NOTIFICATION_ID, builder.build());
